...
class TestOperations(unittest.TestCase):
    def test_transpose(self):
        test = np.asarray([[1, 2],
                           [3, 4]], dtype=np.complex_)
        expected = np.asarray([[1, 3],
                               [2, 4]], dtype=np.complex_)
        np.testing.assert_equal(op.transpose(test), expected)

    def test_dagger(self):
        test = np.asarray([[1, 2 + 1j],
                           [3, 4 + 2j]], dtype=np.complex_)
        expected = np.asarray([[1, 3],
                               [2 - 1j, 4 - 2j]], dtype=np.complex_)
    ...
    def test_multiply2x2complex(self):
        expected = np.asarray([[30 - 3j, 15 + 7j],
                               [25 + 6j, 9 + 9j]], dtype=np.complex_)
    ...
    def test_upper_triangle(self):
        test = np.asarray([[8, -6, 2],
                           [-6, 7, -4],
                           [2, -4, 3]], dtype=np.complex)
        expected = np.asarray([[8, -6, 2],
                               [0, 2.5, -2.5],
    ...
    def test_adjugate(self):
        test = np.asarray([[-3, 2, -5],
                           [-1, 0, -2],
                           [3, -4, 1]])
        expected = np.asarray([[-8, 18, -4],
                               [-5, 12, -1],
                               [4, -6, 2]])
    ...
    def test_minor_matrix2(self):
        test = np.asarray([[-3, 2, -5],
                           [-1, 0, -2],
                           [3, -4, 1]])
        expected = np.asarray([[-3, -5],
                               [3, 1]])
        np.testing.assert_equal(op.minor_matrix(test, 1, 1), expected)

    def test_inverse(self):
        test = np.asarray([[3, 0, 2],
                           [2, 0, -2],
                           [0, 1, 1]])
        expected = np.asarray([[0.2, 0.2, 0],
                               [-0.2, 0.3, 1],
                               [0.2, -0.3, 0]])
    ...
    def test_cross_product(self):
        ...
        b = np.asarray([[5],
                        [6],
                        [7]])
        expected = np.asarray([[-3],
                               [-6],
                               [-3]])
        np.testing.assert_equal(op.cross_product(a, b), expected)
